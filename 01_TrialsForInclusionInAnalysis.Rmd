...
We would like to acknowledge in particular Professor Malcolm Riley's and Dr. Sue Thompson's effort in establishing and coordinating early field trials between 2010 and 2014 and GRDC for funding many of the trials featured in this meta-analysis.
...
## Import data  
**Import data from trials where we obtained the raw data**  
```{r import_dataRAW}
PM_MB_raw <-
   rbind(
      read.csv(
...
One more trial will be removed for our yield data set `PM_dat_Y` for not reporting yield variance.  
