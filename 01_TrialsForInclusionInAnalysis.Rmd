...
## Trial variance
We need variance for each treatment for the data to be useful in a meta-analysis.
Lets look at which of the included trials contain variance for both response variables of interest, yield and disease severity.
...
Four trials will be removed for our disease severity data set `PM_dat_D` for not reporting yield variance.  
