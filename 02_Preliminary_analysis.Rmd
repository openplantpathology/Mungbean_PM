...
Data from `r length(unique(PM_MB_means$trial_ref))` trials were collected and the means of each treatment calculated in the [Data wrangling vignette](`here("vignette/191115_PMMB_DataWrangling_PM.Rmd")`). These data were combined into one file `1902 powdery mildew-Mungbean - Collated means.csv`.
