...
From the data that we have, it is difficult to determine if there is an association between powdery mildew severity and grain yield in no spray control plots.
