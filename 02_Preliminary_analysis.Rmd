...
YV1[[3]]
```
This plot shows a large amount of yield volatility in all cultivars except green diamond. Green Diamond shows little volatility probably because this cultivar is only featured in `r length(unique(PM_MB_means[PM_MB_means$host_genotype == "Green Diamond","trial_ref"]))` trial. 
