...
Trial mean yields in DMI fungicide treated plots
```{r Yield_DMITrials}
PM_MB_dat %>%
...
PM_MB_dat %>%
   ...
   group_by(trial_ref,
            ...
            first_sign_disease) %>%
   summarise(n = n(),
             m_PM_sev_control = mean(PM_sev_control, na.rm = TRUE),
             min_PM_sev = min(PM_sev_treat, na.rm = TRUE),
             max_PM_sev = max(PM_sev_treat, na.rm = TRUE),
             m_PM_yeild_control = mean(PM_y_control, na.rm = TRUE),
             min_PM_yeild = min(PM_y_treat, na.rm = TRUE),
             max_PM_yeild = max(PM_y_treat, na.rm = TRUE),
             )%>%
   ...
   set_header_labels(trial_ref = "Trial code",
                     ...
                     first_sign_disease = "PM onset date",
                     n = "n treatments",
                     m_PM_sev_control = "Control mean PM severity",
                     min_PM_sev = "Minimum PM severity*",
                     max_PM_sev = "Maximum PM severity*",
                     m_PM_yeild_control = "Control mean yeild",
                     min_PM_yeild = "Minimum yeild*",
                     max_PM_yeild = "Maximum yeild*"
                     )
```
