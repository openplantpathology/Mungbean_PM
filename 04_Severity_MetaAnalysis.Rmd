...
```{r}
PM_dat_D$yi_percent <- ((PM_dat_D$PM_final_severity)/median(PM_dat_D$PM_final_severity) * 100)
PM_dat_D$vi_percent <- PM_dat_D$vi/median(PM_dat_D$PM_final_severity)
hist(PM_dat_D$yi_percent)
summary(PM_dat_D$yi_percent)
```
