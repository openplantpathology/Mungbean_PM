...
write.csv(
   ...
   "C:/Users/U8011054/OneDrive - USQ/Cloudstor/Mungbean/2010 PMmung Hermitage means.csv"
)
...
Herm_11 <-
   cbind(new_cols, as.data.table(Herm_11)[, 'Treatment!' := NULL])
...
King_11 <-
   read_xls(
      "C:/Users/U8011054/OneDrive - USQ/Cloudstor/Mungbean/Past trials/2011/2011 PMmung King/pmKing ratings2011.xls",
      sheet = "analyses"
   )
...
King_11 <-
   cbind(new_cols, as.data.table(King_11)[, 'Treatment!' := NULL])
...
write.csv(
   as.data.frame(King_11_m),
   "C:/Users/U8011054/OneDrive - USQ/Cloudstor/Mungbean/2011 PMmung Kingaroy means.csv"
)
...
Goolhi.13 <-
   as.data.frame(
      read_xlsx(
         path = "C:/Users/U8011054/USQ/SCP - Documents/DAW1810/Mungbean/Past trials/2013/AM1305 Fungicides for powdery mildew in mungbean - Goolhi.xlsx",
         sheet = "33DAT1",
         range = "A15:AG75",
         col_names = TRUE
      )
...
Goolhi.13D <-
   Goolhi.13[, c("Treat", "Rep", "Run", "Plot", "Incidence")]
...
MarysM.13D <-
   as.data.frame(
      read_xlsx(
         path = "C:/Users/U8011054/USQ/SCP - Documents/DAW1810/Mungbean/Past trials/2013/AM1304 Fungicides for powdery mildew in mungbean - Marys Mount.xlsx",
         sheet = "19 DAT1 19-3-2013",
         range = "A14:DC72",
         col_names = TRUE
      )
   )
...
for (i in seq_along(incidence2)) {
   ...
   # incidence = 9
   if (sum(MarysM.13D[i, 58:107] >= 1) > 0 &&
       sum(MarysM.13D[i, 7:56] >= (10 * 5 * 100 * 0.75)) &&
...
MarysM.13D <-
   MarysM.13D[, c("Treat", "Rep", "Run", "Plot", "Incidence")]
...
write.csv(
   MarysM.13D,
   "C:/Users/U8011054/USQ/SCP - Documents/DAW1810/Mungbean/Past trials/2013/AM1304-MaryMount-Disease_means.csv"
)
...
write.csv(
   MarysM.13Y,
   "C:/Users/U8011054/USQ/SCP - Documents/DAW1810/Mungbean/Past trials/2013/AM1304-MarysMount-Yield_means.csv"
)
...
Premer.13D <-
   as.data.frame(
      read_xlsx(
         path = "C:/Users/U8011054/USQ/SCP - Documents/DAW1810/Mungbean/Past trials/2013/AM1303 Fungicides for powdery mildew in mungbean - Premer.xlsx",
         sheet = "31 DAT1 31-3-2013",
         range = "A14:DC52",
         col_names = TRUE
      )
   )
...
Premer.13D <-
   Premer.13D[, c("Treat", "Rep", "Run", "Plot", "Incidence")]
...
write.csv(
   Premer.13D,
   "C:/Users/U8011054/USQ/SCP - Documents/DAW1810/Mungbean/Past trials/2013/AM1303-Premer-Disease_means.csv"
)
...
write.csv(
   Premer.13Y,
   "C:/Users/U8011054/USQ/SCP - Documents/DAW1810/Mungbean/Past trials/2013/AM1304-Premer-Yield_means.csv"
)
...
Millm.13D <-
   as.data.frame(
      read_xlsx(
         path = "C:/Users/U8011054/USQ/SCP - Documents/DAW1810/Mungbean/Past trials/2013/BB1305 Fungicides for powdery mildew in mungbean - Millmerran.xlsx",
         sheet = "Assessment Sheet 24.4.2013",
         range = "A12:AH56",
         col_names = TRUE
      )
   )
...
incidence4 <-
   vector(mode = "numeric", length = length(Millm.13D[, 1]))
...
Millm.13D <-
   Millm.13D[, c("Run", "Range", "Treatment", "Replicate", "Incidence")]
...
write.csv(
   Millm.13D,
   "C:/Users/U8011054/USQ/SCP - Documents/DAW1810/Mungbean/Past trials/2013/BB1305-Millmerran-Disease_means.csv"
)
...
write.csv(
   Millm.13Y,
   "C:/Users/U8011054/USQ/SCP - Documents/DAW1810/Mungbean/Past trials/2013/AM1305-Millmerran-Yield_means.csv"
)
...
Herm_15 <-
   read.xlsx(
      "C:/Users/U8011054/OneDrive - USQ/Cloudstor/Mungbean/Past Trials/2015 PMmung Herm/Mugbean powdery mildew 2014-15 inc results v2.xlsx",
...
write.csv(
   Herm_15_m[2:7, ],
   "C:/Users/U8011054/OneDrive - USQ/Cloudstor/R/Powdery_mildew_Mungbean/Herm_15_means.csv"
)
...
Herm_16 <-
   read.xlsx(
      "C:/Users/U8011054/OneDrive - USQ/Cloudstor/Mungbean/Past Trials/2016/Yeild Data 2016 Kingaroy Hermitage (PaulM adjusted).xlsx",
      sheet = "Hermitage",
      startRow = 1,
      colNames = TRUE
   )[1:28, 1:9]
...
Herm_16.DR  <-
   read.xlsx(
      "C:/Users/U8011054/OneDrive - USQ/Cloudstor/Mungbean/Past Trials/2016/2016 Mungbean PM trials summary.xlsx",
...
Herm_16.DR <- Herm_16.DR %>%
   ...
   separate(
      col = ass_date,
      into = c("ass_date", "days_after_emergence"),
      sep = "\\.",
      extra = "merge"
   )
...
Fogerty_17 <-
   read.xlsx(
      "C:/Users/U8011054/OneDrive - USQ/Cloudstor/Mungbean/Past Trials/2017/Fogerty Work File 2017 (Autosaved).xlsx",
      sheet = "Data",
      startRow = 3,
      colNames = TRUE,
      detectDates = TRUE
...
Herm_17 <-
   read.xlsx(
      "C:/Users/U8011054/OneDrive - USQ/Cloudstor/Mungbean/Past Trials/2017/Hermitage working file 2017 .xlsx",
...
Herm_17_sum <- Herm_17 %>%
   group_by(Chemical,
            ...
            Management) %>%
   summarise(
      PM_final_severity = mean(`I_11/05/2017`, na.rm = TRUE),
...
Herm_17_sum <-
   with(Herm_17_sum, Herm_17_sum[order(Manage.Trt, Chemical, `Row.Spacing.(m)`), ])
...
Well_18 <-
   read.xlsx(
      "C:/Users/U8011054/OneDrive - USQ/Cloudstor/Mungbean/Past Trials/2018/Wellcamp Fungicide x Row Spacing x Plant Population - Experimental Design Fogarty 2018.xlsx",
      sheet = "Data",
      startRow = 1,
      colNames = TRUE
   )
...
Well_18.1$ass_date_i <-
   as.Date(gsub("S.", "", Well_18.1$ass_date_i), format = "%d-%m-%y")
names(Well_18.1)[9] <- c("Assessment_date")
Well_18.1 <- Well_18.1[c(1:10, 12)]


Well_18.1$Row.Spacing <-
   as.numeric(unlist(strsplit(Well_18.1$Row.Spacing, " mtr")))


write.csv(
   Well_18.1,
   "C:/Users/U8011054/OneDrive - USQ/Cloudstor/Mungbean/2018_Wellcamp.csv"
)

Well_18_means <- Well_18.1 %>%
   group_by(Row.Spacing, Fungicide, Plant.Pop) %>%
   summarise(
      Yield = mean(`Yield./.ha`, na.rm = TRUE),
...
write.csv(
   Well_18_means,
   "C:/Users/U8011054/OneDrive - USQ/Cloudstor/Mungbean/2018_Wellcamp means.csv"
)
...
col.ident <- function(x1, x2) {
   ...
   if (length(x1) != length(x2)) {
      cat("vector lengths don't match")
      break
   } else{
...
write.csv(
   dat5,
   "C:/Users/U8011054/OneDrive - USQ/Cloudstor/Mungbean/Past trials/2017/2018 Wellcamp final mean incidence.csv"
)
...
PM_MB_19 <-
   read.xlsx(
      "C:/Users/U8011054/USQ/SCP - Documents/DAW1810/Mungbean/1901_Herm_PM/1901 Mungbean powdery mildew disease and yeild data.xlsx",
      startRow = 2,
      cols = c(1:21)
   )
...
PM19_means <- PM_MB_19 %>%
   ...
   summarise(
      Incidence190423 = mean(`23-4-19.Incedence`, na.rm = TRUE),
...
PM_MB_19$AUDPC <- NA
PM_MB_19[PM_MB_19$TOS.NUM == 1 , "AUDPC"] <-
   audpc(PM_MB_19[PM_MB_19$TOS.NUM == 1 , c(5, 7)], c(70, 78))
PM_MB_19[PM_MB_19$TOS.NUM == 2 , "AUDPC"] <-
   audpc(PM_MB_19[PM_MB_19$TOS.NUM == 2 , c(5, 7, 9)], c(70, 78, 86))
...
write.csv(
   PM19_means,
   "C:/Users/U8011054/USQ/SCP - Documents/DAW1810/Mungbean/1901_Herm_PM/2019_PM_Mungbean_treatMeans.csv"
)
...
PM_MB_means <-
   read.xlsx(
      "C:/Users/U8011054/OneDrive - USQ/Documents/GitHub/Mungbean_PM/data/1902 powdery mildew-Mungbean - Collated means.xlsx",
      detectDates = TRUE
   )
