...
estAUDPC <- PM_MB_dat[is.na(PM_MB_dat$AUDPC_m) &
                           !is.na(PM_MB_dat$PM_final_severity),]
...
PM_MB_dat[is.na(PM_MB_dat$AUDPC_m) &
               !is.na(PM_MB_dat$PM_final_severity),"AUDPC_m"] <- estAUDPC$AUDPC_m
