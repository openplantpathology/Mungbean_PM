...
# An end date between 
#     80 days after planting and 110 days after planting.
# 
...
# use Bomrang to find the quantaty of rain for the season and do a linear regression
      ...
      write.csv(lm_rain, file = "data/lmInSeasonRainfall_10.30_65.100.csv", row.names = FALSE)
      ...
      write.csv(lm_rain, file = "data/lmInSeasonRainfall_10.30_65.100_HERM.csv", row.names = FALSE)
