...
#     between 10 days before planting and 20 days after planting
# An end date between 
#     50 days after planting and 110 days after planting.
# 
...
# use Bomrang to find the quantaty of rain for the season and do a linear regression
      ...
      write.csv(lm_rain, file = "data/lmInSeasonRainfall_-10.20_50.110.csv", row.names = FALSE)
