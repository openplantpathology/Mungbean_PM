...
# lm_rain <- read.csv("data/lmInSeasonRainfall_-10.20_50.110.csv",stringsAsFactors = FALSE)
# lm_rain <- read.csv("data/lmInSeasonRainfall_10.30_60.95.csv",stringsAsFactors = FALSE)
# lm_rain <- read.csv("data/lmInSeasonRainfall_20.40_80.110.csv",stringsAsFactors = FALSE)
# lm_rain <- read.csv("data/lmInSeasonRainfall_-10.30_50.80.csv",stringsAsFactors = FALSE)
