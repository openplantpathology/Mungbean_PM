...
slimer_PM_dat <- slimer_PM_dat[!is.na(slimer_PM_dat$yield_error),]
slimer_PM_dat$yi <- log(slimer_PM_dat$grain_yield.t.ha*1000)
slimer_PM_dat$spray_management

PM_mv_AI <- rma.mv(yi,yield_error,
