...
Treatments which incorporating multiple fungicide applications, $Recommended_{plus}$ and $Late_{plus}$, produced the highest mean yield protection estimates at `r round(PM_mv$b[4,1] * 1000, 2)` (SE = `r round(PM_mv$se[4] * 1000, 2)`&nbsp;kg&nbsp;/&nbsp;ha) and `r round(PM_mv$b[6,1] * 1000, 2)`&nbsp;kg&nbsp;/&nbsp;ha (SE = `r round(PM_mv$se[6] * 1000, 2)`&nbsp;kg&nbsp;/&nbsp;ha) respectively (Table 3). 
