...
:::
<!-- Is anyone aware of a way to put the "Type of paper" text above the renderd YAML header? ... or ... Specify extra text in the header which is rendered as a different style? 
I am considering dropping the lua files and just codeing in the different styles to suit the MDPI_Agronomy_Template.docx -->
