...
King_11_dat <- cbind(King_11_dat,
                     AUDPC = apply(data.frame(zero = 0,
                                              King_11[,c("9 w.a.p.","11 w.a.p.","14 w.a.p.")]-1),
                                   1, 
                                   FUN = audpc,
...
King_11$PM_zero <- 1
King11_plot <- melt(King_11, id.vars = c("Treatment!","cultivar","rep!","spray_n","fungicide"),
                  measure.vars = c("PM_zero","9 w.a.p.","11 w.a.p.","14 w.a.p."))
