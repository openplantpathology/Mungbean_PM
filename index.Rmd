...
A common practice for managing powdery mildew in mungbean is to couple fungicide with an insecticide spray early in the development of the crop, usually before the disease is detected.
This is despite the current recommendations that the best yield protection is achieved when the fungicide is first applied at the first sign of the disease.
These recommendations were based on individual studies, many of which lacked sufficient power to draw significant conclusions.
We undertook a meta-analysis to determine, when should the first fungicide spray be applied on mungbean to maximise yield protection.  
