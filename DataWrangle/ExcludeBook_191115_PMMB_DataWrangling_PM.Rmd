...
Herm_10$PM_zero <- 1
Herm_plot <- melt(Herm_10, id.vars = c("Description!","Treat!", "Rep!","Cultivar!","fungicide","total_fungicide"),
                  measure.vars = c("PM_zero","P.M.9wap","P.M.11wap","P.M.13wap"))

Herm_plot <- Herm_plot %>%
   mutate(T_var = case_when(variable == "PM_zero" ~ 
                               as.numeric((Herm_10_dat$first_sign_disease[1]-7) - Herm_10_dat$planting_date[1]),
