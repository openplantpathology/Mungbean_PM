...
PM_MB_means[PM_MB_means$trial_ref == "mung0910/01",]
Herm_10_m
...
Herm_16_m$AUDPC_se <- NA

Herm_16_m$PM_final_severity <- Herm_16_m$dae63

Herm_16_m <- fold_data(Herm_16_m, PM_MB_means)
Herm_16_m <- Herm_16_m[,!colnames(Herm_16_m) %in% c('Treatment',"dae24","dae38","dae48","dae63","Final_Yield_tHa", "AUDPC_m")]
...
King_16_m <- King_16_m[,!colnames(King_16_m) %in% c('Treatment',"dae20","dae34","dae46","Final_Yield_tHa", "AUDPC_m")]
