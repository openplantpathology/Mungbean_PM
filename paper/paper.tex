...
\Author{Paul Melloy$^{1,*}$\href{https://orcid.org/0000-0003-4253-7167}{\orcidicon}, Emerson Del Ponte$^{2}$\href{https://orcid.org/0000-0003-4398-409X}{\orcidicon}, Adam H. Sparks$^{1}$\href{https://orcid.org/0000-0002-0061-8359}{\orcidicon}}
...
\address{%
$^{1}$ \quad University of Southern Queensland
Centre for Crop Health
Toowoomba, Queensland, 4350 Australia; \\
$^{2}$ \quad Universidade Federal de Viçosa
Departamento de Fitopatologia
Viçosa, 36570-000 Minas Gearais, Brazil; \\
}
% Contact information of the corresponding author
\corres{Correspondence: \href{mailto:Paul.Melloy@usq.edu.au}{\nolinkurl{Paul.Melloy@usq.edu.au}}; Tel.: +61 7 4631 5527}
...
While research outside of Australia refers to the causal agent of mungbean powdery mildew as \emph{Erysiphe polygoni} . Here-after we will refer to the pathogen as \emph{P. xanthii}

\emph{P. xanthii}, is an obligate biotroph, requiring a living plant host to survive and complete it's lifecycle \citep{PerezGarcia2009}.
...
\emph{P. xanthii} has one of the widest host ranges of the powdery mildews, an ability which likely assists this pathogen to survive between mungbean seasons on alternative hosts which have not yet been identified in Australia.
...
Powdery mildew colonies of crowded conidophores can develop rapidly on leaf surfaces causing a loss in photosynthetic potential leading to reduced yield quantity and quality \citep{PerezGarcia2009}.
...
\multicolumn{6}{l}{\textsuperscript{b} Northern Grower Alliance}\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\authorcontributions{For research articles with several authors, a short paragraph specifying their
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\conflictsofinterest{Declare conflicts of interest or state `The authors declare no conflict of
...
DAF & Queensland Department of Agriculture, Fisheries and Forestry \\
DMI & Demethylase inhibitor \\
DSS & Decision support system \\
FRAC & Fungicide Resistance Action Committee \\
GRDC & Grains Research and Development Corporation \\
NGA & Northern Grower Alliance \\
