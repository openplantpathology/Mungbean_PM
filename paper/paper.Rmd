...
>>>>>>> ac3ed156ba3818392aec04fc713e4ec20f52d07a
...
mean(ymd(PM_Mdat$planting_date), na.rm = TRUE)
...
PM_Mdat %>%
  ...
  mutate(season_length = case_when(
    is.na(planting_date) ~ harvest_date - mean(planting_date,na.rm = TRUE),
    is.na(harvest_date) ~ mean(harvest_date,na.rm = TRUE) - planting_date,
    TRUE ~ harvest_date - planting_date
  ))
