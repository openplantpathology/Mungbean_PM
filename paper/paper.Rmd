...
# Data
source(here("R/import_data.R")) # load `import_data()`
...
Currently, Jade-AU\pbr has the the best disease resistance to powdery mildew (moderately susceptible), with cv. Green Diamond also having some resistance [@Sparks2017].
