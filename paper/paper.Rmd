...
Along with these bacterial, fungal and phytoplasma caused diseases, another fungal disease, powdery mildew, can reduce yields by up to 40% [@Chankaew2013] in susceptible cultivars. The disease is caused by  The damage can be mitigated through an integrated disease management strategy of fungicide treatments and cultural practices and loci conferring resistance in mungbean have been identified [@Zhang2008]. However, to date, the focus in Australia has remained on breeding for disease resistance to bacterial diseases rather than powdery mildew due to the wide availability of fungicides for use in controlling powdery mildew. <!-- Best to get a quote from Col here so we can say "personal comm". I've heard him say this at a mungbean field day, I believe. -->
