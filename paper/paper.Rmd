...
If time permitted a second spray after the first "late" application, on average the meta-analysis shows this would be optimal, as the $LatePlus$ treatment significantly limited yield loss by `r round(contrast_Ssum$coefficients[15], 4)*1000` kg ha^-1^, when compared to the $Late$, single spray treatment `r reportP(contrast_Ssum$pvals[15])` <!--This needs checking and correcting, T3 says late and latePlus were significantly different however the contrasts.Rdata says it is not-->.
