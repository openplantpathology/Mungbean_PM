...
The data for this study were obtained through studies that were conducted by the authors, FAIR (Findable, Accessible, Interoperable, Reusable) data available from GRDC Online Farm Trials <https://www.farmtrials.com.au/><!--Technically we did not use data from this location we obtained it from Lawrie Price-->, personal correspondence with colleagues and collaborating institutions.
