...
The disease cycle of the pathogen can be as short as five days for a germinating conidia to infect the host and produce new reproductive structures, conidiophores, which produce more conidia, and which then disseminate to new infection sites [@PerezGarcia2009; @Sparks2017].
...
The data for this study were obtained through studies that were conducted by the authors, FAIR (Findable, Accessible, Interoperable, Reusable) data available from GRDC Online Farm Trials <https://www.farmtrials.com.au/>, and through personal correspondence with colleagues and collaborating institutions.
