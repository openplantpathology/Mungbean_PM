...
where $Y_i$ is the response, a vector of the grain yield measurements (tonnes per hectare) for each treatment in the $i$th trial over total number ($K$) of trials ($i$  = 1, ...$K$). 
