...
We already have a factor breaking down the dose in the `trial` variable, Let's make a new one without dose.
...
For now Let's assign the most used row spacing of 0.33
```{r}
