...
Trials
```
Lets use this list of trials to subset the data and calculate sampling variances.  
...
Lets have a quick look to examine whether trials with high disease pressure sustain a greater yield loss.  
...
For now lets assign the most used row spacing of 0.33
```{r}
