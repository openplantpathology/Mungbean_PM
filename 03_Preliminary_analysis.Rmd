...
Plot one and two applications of the main sprays

```{r Fungicide_x_nSprays_tble, message=FALSE}

PM_MB_means[PM_MB_means$fungicide_ai == "sulphur (SC)"|
               PM_MB_means$fungicide_ai == "sulphur (WP)"|
               PM_MB_means$fungicide_ai == "sulphur (Ultra SC)","fungicide_ai"] <- "sulphur"

PM_MB_means$sprays <- sapply(PM_MB_means$total_fungicide, FUN = function(x){if(x == 1){return("one")}else{return("plus")}})
