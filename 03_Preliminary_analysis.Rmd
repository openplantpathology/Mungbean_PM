...
```
Volitility of the cultivars are fairly similar when trial is not considered as a factor. Green diamond shows little volatility however this cultivar is only featured in `r length(unique(PM_MB_means[PM_MB_means$host_genotype == "Green Diamond","trial_ref"]))` trials.  
...
YV2_crystal <- yield_volatility("Jade",control_only = TRUE)
YV2_crystal[[2]]
