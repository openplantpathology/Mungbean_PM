...
First lets investigate the difference in the effect of the type of fungicide on proportion of yield saved?  
...
There is much variation in the propiconazole dose, lets inspect the difference in yields for each dose.
...
PM_MB_means[PM_MB_means$fungicide_ai == "control"
               ,]
...
### Mungbean cultivars  
What role does host genotype have in tolerating disease preasure and is it likely to influence the meta-analysis.  
...
Lets plot a stacked barplot of the number of sprays for both demethylation inhibitors, tebuconazole and propiconazole against each cultivar.
...
PM_MB_means %>%
   ...
   xlab("Cultivar") +
   ylab("N Trials") +
   ggtitle(label = "Cultivars used in tebuconazole trials") +
   geom_col() +
   scale_fill_usq() +
   scale_colour_usq() +
   theme_usq()
