...
1. Type of Fungicide sprayed
2. In-crop rainfall
3. mungbean cultivar
4. Fungicide dose (we don't expect this to influence as it was only changes slightly)
5. Mean daily temperature in the weeks following spray application
6. Row spacing
7. Two pathogen species cause PM (new discovery)
8. irrigated vs non-irrigated trials
9. Number of fungicide sprays (edited) 
...
The approximate period when in-crop rainfall impacts the most on the mean harvest is between 11 - 88 days after planting.
