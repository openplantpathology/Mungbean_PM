...
PM_MB_means$Fungicide_application_1[as.character(PM_MB_means$Fungicide_application_1) == ""] <-
   NA
PM_MB_means$Fungicide_application_2[as.character(PM_MB_means$Fungicide_application_2) == ""] <-
   NA
PM_MB_means$Fungicide_application_3[as.character(PM_MB_means$Fungicide_application_3) == ""] <-
   NA
PM_MB_means$Fungicide_application_4[as.character(PM_MB_means$Fungicide_application_4) == ""] <-
   NA
PM_MB_means$Fungicide_application_5[as.character(PM_MB_means$Fungicide_application_5) == ""] <-
   NA
PM_MB_means$Fungicide_application_6[as.character(PM_MB_means$Fungicide_application_6) == ""] <-
   NA
PM_MB_means$Fungicide_application_7[as.character(PM_MB_means$Fungicide_application_7) == ""] <-
   NA

# Rewrite all variations of sulphur treatments as just sulphur
PM_MB_means$Fungicide[PM_MB_means$Fungicide == "Sulphur" |
                         PM_MB_means$Fungicide == "Sulphur (SC)" |
                         PM_MB_means$Fungicide == "Sulphur (Ultra SC)" |
                         PM_MB_means$Fungicide == "Sulphur (WP)"] <- "Sulphur"
```
