...
Mungbean is grown as a short season summer legume crop which can provide a high returns for growers in eastern Australia. 
A crop potentially yields up to 2.3 tonnes per hectare, with a value of up to \$ 1300 a tonne [@QueenslandGovernment2019]. 
...
Fortunately a number of strategies are able to be employed to reduce the damage powdery mildew inflicts on yields.
...
Therefore when sowing is delayed there is a greater chance powdery mildew will infect earlier in the crop development leading to greater yield losses.  

Commercially available mungbean cultivars in Australia lack sufficient resistance to be used solely as a management strategy for mitigating yield losses.
Quantitative disease resistance has been observed in breeding lines [@Pandey2018; @Chankaew2013] and mungbean cultivars such as Jade-AU, however other management strategies, such as fungicides, are still required[@Kelly2017a].
