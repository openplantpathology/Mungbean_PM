...
However these potenitial crop yields can be limited by diseases such as powdery mildew (*Podosphaera xanthii*) by up to 40% [@Kelly2017a; @Chankaew2013]. 
Fortunatley a number of strategies are able to be employed to reduce the damage powdery mildew inflicts on yields.
...
Commercially available mungbean cultivars in Australia lack sufficient resistance to be used soley as a management strategy for mitigating yield losses.
