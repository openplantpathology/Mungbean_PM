...
<<<<<<< HEAD:07_Publication_wireframe_and_8Questions.Rmd
## Who are the intended readers? - list 3 to 5 of them by name  
   * Adam Sparks – disease modeller  
...
## Who are the intended readers? - list 3 to 5 of them by name
   ...
   * Jean Galloway – Plant disease modeller
   * Art Diggle – Plant disease modeller
>>>>>>> Adam:06_Publication_wireframe_and_7_Questions.Rmd
...
=======
## Why did you do it? (limit - 50 words)
The unpublished field trial data independantly did not provide a clear indication for when to apply fungicide to best mitigate yield losses from powdery mildew. By analysing the collective data we aim to provide a better estimate for fungicide application timing to mitigate the yield loss from powdery mildew.
>>>>>>> Adam:06_Publication_wireframe_and_7_Questions.Rmd
...
## Introduction
Mungbean is a short season summer pulse crop which can provide a high returns for growers in eastern Australia. Mungbean can potentially yield up to 2.3 tonnes per hectare, and worth up to \$ 1300 a tonne [AgMargins; 2019](https://agmargins.net.au/Reports/Details/fced3a80-a762-481c-b812-9953e33410e6). Powdery mildew _Podosphaera xanthii_ can potentially cause yield losses on mungbean of up to 43%. Fortunatley a number of strategies are employed to reduce the damage powdery mildew inflicts on yields.
