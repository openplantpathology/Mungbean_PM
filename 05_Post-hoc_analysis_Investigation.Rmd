...
Let's estimate the age of the crop based on crop maturity observations, we will use the `PM_MB_dat_full` which include some observations of crop maturity.
