...
King_16_dat <- 
   data.frame(trial_ref = "mung1516/02",
              ...
              harvest_date = as.Date("2015-05-10", format = "%Y-%m-%d"),
              final_assessment = as.Date("2015-04-19", format = "%Y-%m-%d"),
              PM_final_severity = NA,
              rating_scale = "1-9",
...
names(King_16.DR)[1:6] <- c("Treatment", "dae20","dae34","dae46","dae60","Final_Yield_tHa")
names(King_16.DR)[6] <- "Final_Yield_tHa"
King_16.DR$n_treatment <- c(3,2,7,6,5,4,1)


King_16_m <- left_join(King_16_m,King_16.DR)
King_16_m$AUDPC.m <- apply(King_16_m[,c("dae20", "dae34", "dae46", "dae60")]-1,1, 
