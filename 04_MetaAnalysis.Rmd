...
for_rows <- function(head_row, gap = NULL, r_order = NULL, ord_var, index){
   if(is.null(gap)){gap <- 0}
   
   trows_F <- function(x1, head_row, gap){
   if(x1 <= length(dat1$spray_management) &&
      x1 > length(dat1$spray_management) - (sum(dat1$spray_management == "Early"))){
      return(x1 + (head_row - length(dat1$spray_management)) - 2)}
   if(x1 <= length(dat1$spray_management) - (sum(dat1$spray_management == "Early")) &&
      x1 > length(dat1$spray_management) - 
      (sum(dat1$spray_management == "Early") + sum(dat1$spray_management == "Late"))){
      return(x1 + (head_row - length(dat1$spray_management)) - (2 + gap))}
   if(x1 <= length(dat1$spray_management) - 
      (sum(dat1$spray_management == "Early") + sum(dat1$spray_management == "Late"))&&
      x1 > length(dat1$spray_management) - 
      (sum(dat1$spray_management == "Early") + sum(dat1$spray_management == "Late") +
       sum(dat1$spray_management == "Recommended"))){
      return(x1 + (head_row - length(dat1$spray_management)) - (2 + gap * 2))}
   if(x1 <= length(dat1$spray_management) - 
      (sum(dat1$spray_management == "Early") + sum(dat1$spray_management == "Late") +
       sum(dat1$spray_management == "Recommended")) &&
      x1 > length(dat1$spray_management) - 
      (sum(dat1$spray_management == "Early") + sum(dat1$spray_management == "Late") +
       sum(dat1$spray_management == "Recommended") + sum(dat1$spray_management == "Recommended_plus"))){
      return(x1 + (head_row - length(dat1$spray_management)) - (2 + gap * 3))}
   if(x1 <= length(dat1$spray_management) - 
      (sum(dat1$spray_management == "Early") + sum(dat1$spray_management == "Late") +
       sum(dat1$spray_management == "Recommended") + sum(dat1$spray_management == "Recommended_plus")) &&
      x1 > length(dat1$spray_management) - 
      ...
      return(x1 + (head_row - length(dat1$spray_management)) - (2 + gap * 4))}
   ...
   dat2 <- list(stitle_row = stitle_row,
            ...
            trows3 = unlist(sapply(index1$ID2,trows_F, head_row = head_row, gap = gap)),
...
index1 <- dat1 %>%
   mutate(spray_management = factor(spray_management, levels = c("Early", "Late","Recommended", "Recommended_plus","Late_plus")))%>%
   arrange(desc(spray_management), location, desc(grain_MD))%>%
   select(ID) %>%
   mutate(ID2 = order(ID))

rows1 <- for_rows(156, index = index1$ID2, gap = 5)
