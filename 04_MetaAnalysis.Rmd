...
polys <- data.frame(ref = names(coef(PM_mv)),
                    x = coef(PM_mv),
                    ci.lb = PM_mv$ci.lb,
                    ci.ub = PM_mv$ci.ub,
                    rows = c(112.8, 64.8, 22.8,93.5, 1.8))

metafor::forest(PM_mv, cex = 1.25 , width = 5,
                order = "fit",
                rows = c(126:114, 111:95, 92:66, 63:24, 21:3),
                ilab = cbind(dat1$trial_ref, dat1$location, dat1$year, 
                             dat1$row_spacing, dat1$host_genotype, dat1$dose),
                ilab.xpos = c(-2.8, -2.2,-2.05,-1.95,-1.7,-1.5),
                slab = NA, 
                xlim = c(-3, 2.2),
                ylim = c(4,129),
...
text(c(-6.5, -5.5,-4.75,-4.15,-3.4,-2.5), 127.9,cex = 0.85, 
