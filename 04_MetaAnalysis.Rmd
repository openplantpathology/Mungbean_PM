...
According to the results of the omnibus test ($Q_M = 7.32, df = 5, p = 0.1979$) we can't reject the null hypothesis $H_0 : \beta_1 = \beta_2 = \beta_3 =\beta_4 = 0$ that the tested spray management schedules have no benefit to protecting mungbean yields [@Viechtbauer2010]. 
...
```{r metafor_contrasts}
meta_cont <- anova(PM_mv_AI, L = rbind(
   c(0, 1, -1, 0, 0,0),
