...
```{r MSE_2_SVar, eval=FALSE, include=FALSE}
...
The Qm [omnibus test](http://www.metafor-project.org/doku.php/tips:models_with_or_without_intercept?s[]=anova) of moderators, show the moderators significantly influence the model ($Q_M = 7.32, df = 5, p < 0.0001$) and we can reject the null hypothesis ($H_0 : \beta_1 = \beta_2 = \beta_3 =\beta_4 = 0$) that there is no difference between the moderators [@Viechtbauer2010]. 
