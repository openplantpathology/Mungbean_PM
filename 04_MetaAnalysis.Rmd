...
Let's do this plot again, but let's look at the proportional mean difference between the treatments and the no spray control for each study.  
...
Using the mean difference in the treatment effect seems to show the impact of each treatment better than just raw yield and reduces the variability in the treatments.
...
dat1 <-
   ...
   mutate(spray_management =
      ...
      c( "Early",
         ...
         "Late",
         "Late_plus")),
      TrialDose = factor(paste(trial, dose, sep = "_"))
      )%>%
   select(
      trial,
      trial_ref,
