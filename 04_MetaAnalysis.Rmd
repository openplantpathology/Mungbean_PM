...
### Sort and arrange data-frame occordingly and produce a index vector to inform the order of each "Trial" on the plot
index1 <- dat1 %>%
...
rows1 <- forest_rows(head_row = 156, 
