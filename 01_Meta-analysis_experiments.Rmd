...
This meta-analysis uses data collected by a number of researchers from the Department of Agriculture and Primary Industries and the University of Southern Queensland. It is worth noting Malcolm Riley and Dr Sue Thompsons effort in establishing and coordinating early field trials between 2010 and 2016.  
...
write.csv(experiment_sites,"data/Mungbean_experiment_sites.csv", row.names = FALSE)
