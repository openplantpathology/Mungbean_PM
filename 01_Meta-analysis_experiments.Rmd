...
Tebuconazole and propiconazole are both classed as demethylase inhibitors. 
We will retain the trials trials which only contain DMI fungicides.  
```{r}
PM_MB_dat %>%
   ...
   arrange(year)
```
We will retain all fungicides for now and remove them before the analysis. 
