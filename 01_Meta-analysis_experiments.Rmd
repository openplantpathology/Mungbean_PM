...
Queensland. It is worth noting Professor Malcolm Riley and Dr Sue Thompson's
...
file "Powdery mildew paper#1.doc". Comparing trials which have not used the same
rating scale will be done using a percentage change.  
...
## Powdery mildew ratings  
   ...
   7. Colonies in lower 2/3 of canopy of 100% of plants, some plants with
   colonies also in top 1/3 of canopy  
...
write.csv(experiment_sites,
          "data/Mungbean_experiment_sites.csv",
          row.names = FALSE)
